...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        if (rect.area() == 0)
        {
            ...
            //weank fix bug: no moudle named std::round
            unsigned long scale = (unsigned long)(std::sqrt(area)+0.5);
        ...
        else
        {
            ...
            //weank fix bug: no moudle named std::round
            return centered_rect(rect, (long)(rect.width()*scale+0.5), (long)(rect.height()*scale)+0.5);
        }
    }
